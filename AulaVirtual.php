...
<div class="body-container"> 
    ...
    <div class="col-lg-5 col-offset-1">
      <div class="panel " id="cont-info">
        <ul id="myTab" class="nav nav-tabs md-tab-nav">
          ...
          <li><a href="#ali" data-toggle="tab">Alimentos</a></li>
          <li><a href="#amb" data-toggle="tab">Ambiental</a></li>   
          <li><a href="#civ" data-toggle="tab">Civil</a></li> 
          <li><a href="#sis" data-toggle="tab">Sistemas</a></li>      
        </ul>
  ...
  </div><!--Fin Iconos Sociales-->

  </div><!--Fin Contenido -->

  <footer class="footer">
    <div>
      <p>©2013 Universidad Peruana Uni&oacute;n - Facultad de Ingeniería y Arquitectura<br />
        Altura Km. 19.5 Carretera Central, Ñaña-Lima <br />
